...
export async function GET() {
  // TODO: Uncomment เมื่อสร้าง SavedJob model แล้ว
...
export async function POST() {
  ...
  return NextResponse.json({ message: "TODO: Implement bookmark" }, { status: 501 });
}
...
export async function DELETE() {
  ...
  return NextResponse.json({ message: "TODO: Implement remove bookmark" }, { status: 501 });
}
